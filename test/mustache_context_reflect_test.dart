  ...
  group('reflect', () {
    ...
    group('field([name])', () {
      test('should return an object', () {
        ...
        expect(actual, new TypeMatcher<Field>());
      });
      ...
      group(".val()", () {
        ...
        test('returns the value from a [] operator', () {
          ...
          expect(actual.val(), new TypeMatcher<Person>());
        ...
        test('returns a ref to the function if it has an arity of 1', () {
          ...
          expect(actual.val(), new TypeMatcher<Function>());
          expect(actual.val()("-"), "[[- 1]]");
        });
      });
    });
    ...
    test('does not use reflection with Maps', () {
      ...
      expect(reflection, isNot(new TypeMatcher<Mirror>()));
    });
    ...
    group('with useMirrors = false', () {
      ...
      test('should return the result of the [] operator', () {
        ...
        expect(value, new TypeMatcher<Person>());
